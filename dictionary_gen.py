...
data=pd.read_csv('/home/quang/Desktop/projects/clean_data/data/test/jobTitle_employment.csv')
data=data[pd.notnull(data['c_employment_title'])]
title_list+=data['c_employment_title'].tolist()
